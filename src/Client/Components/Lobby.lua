    ...
    return Roact.createElement("Frame", { Size = UDim2.fromScale(1, 1), BackgroundColor3 = Color3.fromRGB(20, 20, 25) }, {
        ...
        CreateOverlay = self.state.createModalVisible and Roact.createElement("TextButton", { Size = UDim2.fromScale(1, 1), BackgroundColor3 = Color3.fromRGB(0, 0, 0), BackgroundTransparency = 0.6, Text = "", AutoButtonColor = false, Active = true, ZIndex = 50, [Roact.Event.Activated] = function() self.closeModal("createModalVisible", self.createScaleRef) end }, {
            ModalBox = Roact.createElement("Frame", { Size = UDim2.fromScale(0.35, 0.65), AnchorPoint = Vector2.new(0.5, 0.5), Position = UDim2.fromScale(0.5, 0.5), BackgroundColor3 = Color3.fromRGB(30, 30, 35), ZIndex = 51 }, {
                ...
                PackButtons = Roact.createElement("ScrollingFrame", { Size = UDim2.fromScale(0.9, 0.12), BackgroundTransparency = 1, ZIndex = 52, LayoutOrder = 5, CanvasSize = UDim2.new(0, 0, 0, 0), AutomaticCanvasSize = Enum.AutomaticSize.X, ScrollingDirection = Enum.ScrollingDirection.X, ScrollBarThickness = 4, ScrollBarImageColor3 = Color3.fromRGB(150, 150, 150) }, { Layout = Roact.createElement("UIListLayout", { FillDirection = Enum.FillDirection.Horizontal, Padding = UDim.new(0, 10), HorizontalAlignment = Enum.HorizontalAlignment.Left }), Standard = Roact.createElement(AnimatedButton, { Text = "STANDARD", BaseSize = UDim2.new(0, 120, 1, 0), TextSize = 16, Color = self.state.selectedWordPack == "Standard" and Color3.fromRGB(52, 152, 219) or Color3.fromRGB(50, 50, 55), ZIndex = 55, OnClick = function() self:setState({ selectedWordPack = "Standard" }) end }), Roblox = Roact.createElement(AnimatedButton, { Text = "ROBLOX", BaseSize = UDim2.new(0, 120, 1, 0), TextSize = 16, Color = self.state.selectedWordPack == "Roblox" and Color3.fromRGB(52, 152, 219) or Color3.fromRGB(50, 50, 55), ZIndex = 55, OnClick = function() self:setState({ selectedWordPack = "Roblox" }) end }) }),
