...
function WaitingRoom:RenderSlotButton(role, color, position)
	...
	return Roact.createElement("TextButton", {
		...
		BackgroundTransparency = isTaken and 0.6 or 0,
...
function WaitingRoom:render()
	...
	return Roact.createElement("Frame", {
		...
		-- RED TEAM
		RedSpy = self:RenderSlotButton("RedSpymaster", Color3.fromRGB(180, 40, 40), UDim2.fromScale(0.05, 0.3)),
		RedOp = self:RenderSlotButton("RedOperative", Color3.fromRGB(180, 40, 40), UDim2.fromScale(0.05, 0.5)),

		-- BLUE TEAM (DISABLED FOR ITERATION 1)
		BlueSpy = self:RenderSlotButton("BlueSpymaster", Color3.fromRGB(40, 90, 180), UDim2.fromScale(0.55, 0.3)),
